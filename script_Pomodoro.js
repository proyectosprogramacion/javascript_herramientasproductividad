...
function cambiarPomodoro(){
  ...
  btnPomodoro.style.background="#a40606";
  btnDescansoCorto.style.background="none";
  btnDescansoLargo.style.background="none";
  btnEmpezar.style.background="#a40606";
...
function cambiarDescansoCorto(){
  ...
  btnDescansoCorto.style.background="#a40606";
  btnDescansoLargo.style.background="none";
  btnEmpezar.style.background="#a40606";
...
function cambiarDescansoLargo(){
  ...
  btnPomodoro.style.background="none";
  btnDescansoCorto.style.background="none";
  btnDescansoLargo.style.background="#a40606";
  btnEmpezar.style.background="#a40606";
  banderaMinuto25=false;
  banderaMinuto05=false;
